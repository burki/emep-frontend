...
class PersonController extends CrudController
{
     ...
     */
    public function exhibitionsByItemAction(
        Request $request,
    ...
    public function detailDataNumberOfWorksPerType($catalogueEntries)
    {
        ...
        $finalData = array_map(
            function ($id) use ($entriesPerType, &$sumOfAllEntries) {
    ...
    public function detailDataNumberOfExhibitionsPerVenue($person)
    {
        ...
        $finalData = array_map(
            function ($id) use ($exhibitionVenues, &$sumOfAllExhibitions) {
    ...
    public function detailDataNumberOfExhibitionsPerCountry($person)
    {
        ...
        $finalData = array_map(
            function ($key) use ($exhibitionPlacesByCountryTotal) {
    ...
    public function detailDataNumberOfExhibitionsPerCity($person)
    {
        ...
        $sumOfAllExhibitions = 0;
        $finalData = array_map(
            function ($key) use ($exhibitionPlaces, &$sumOfAllExhibitions) {
